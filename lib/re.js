            ...
            function _callee$(_context) {
               while (1) {
                  switch ((_context.prev = _context.next)) {
                     case 0:
                        ;(_separateAltQuery = separateAltQuery(
                           node.properties.alt
                        )),
                           (fetchWay = _separateAltQuery.fetchWay),
                           (attributes = _separateAltQuery.attributes)
                        _context.next = 3
                        return nodeAfterFetch(node, fetchWay, dirpath)
...
var nodeAfterFetch = (function() {
   var _ref2 = _asyncToGenerator(
      /*#__PURE__*/ _regeneratorRuntime2.default.mark(function _callee2(
         node,
         fetchWay,
         dirpath
      ) {
            ...
            function _callee2$(_context2) {
               while (1) {
                  switch ((_context2.prev = _context2.next)) {
                     ...
                     case 6:
                        _context2.next = 8
                        return (0, _fetch.fetchToHast)(fetchPath)
                     ...
                     case 8:
                        ...
                        if (
                           ...
                           reNode = hast.children.find(function(_ref3) {
                              var type = _ref3.type
                              return type === 'element'
                           })
                     ...
                     case 15:
                        ...
                        _context2.next = 18
                        return (0, _fetch.fetchToBlobUrl)(fetchPath)
   ...
   return function nodeAfterFetch(_x3, _x4, _x5) {
